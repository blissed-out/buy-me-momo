...
const login = () => {
    ...
    return (
        <>
            <h1 className="flex items-center justify-center login text-2xl mt-14 text-neutral-300 font-bold text-center">
                Login to <div className="logo gap-2 flex items-center text-2xl px-2">
                    Buy me
                    <img src="/icons/momo.png" alt="" width={40} typeof='png' />Mo:mo
                </div>
            </h1>
            <div className="flex flex-col items-center justify-center gap-2 p-10">
                ...
                <button
                    className="flex min-w-64 items-center border border-gray-500 rounded-lg shadow-md max-w-xs px-8 py-2 text-sm font-medium text-neutral-300 hover:bg-neutral-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
